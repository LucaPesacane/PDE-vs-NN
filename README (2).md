...
> University project — Politecnico/Ingegneria Informatica, Università degli Studi di Napoli Federico II. Exam: *Calcolo Scientifico per l'Innovazione Tecnologica*.
...
└── results/                               # (optional) exported plots/screenshots
```
